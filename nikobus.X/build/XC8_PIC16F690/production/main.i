...
static eeprom uint8_t config[] = {0,0,0,0};
...
_delay((unsigned long)((1250)*(8000000/4000000.0)));
}
...
_delay((unsigned long)((2800)*(8000000/4000000.0)));
...
if ((timer > 149) && (timer < 193)) {

} else if ((timer > 118) && (timer < 149)) {
...
if (bitsReceived == 24) {
busMessage.rawData[0] = busBuffer.rawData[0];
busMessage.rawData[1] = busBuffer.rawData[1];
busMessage.rawData[2] = busBuffer.rawData[2];
